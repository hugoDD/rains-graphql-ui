  ...
  <div class="app-container">
    <el-form :inline="true">
      <el-form-item label="菜单名称">
        <el-input
          v-model="queryParams.re_menuName"
          placeholder="请输入菜单名称"
          clearable
          size="small"
...
import { addRsqlDateRange, objToRsql, requestParam } from '../../../utils'
import { initRoleQuery } from '../../../operation/roleQuery'
...
export default {
  ...
  created() {
    ...
    this.$graphql(initMenPages,{request:{...reqParam}}).then(
      r => {
        this.menuList = this.handleTree(r.data.pages.data);
        this.visibleOptions =  r.data.dictShowHide.data;
        this.loading = false;
      }
    )
  ...
  methods: {
    ...
    getList() {
      ...
      listMenu(this.queryParams).then(response => {
        this.menuList = this.handleTree(response.data.pages.data);
//        this.menuList = this.handleTree(response.data, "menuId");
    ...
    getTreeselect() {
      listMenu().then(response => {
        ...
        menu.children = this.handleTree(response.data.pages.data);
