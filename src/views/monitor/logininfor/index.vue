<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      <el-form-item label="登录地址" prop="re_ip">
        <el-input
          v-model="queryParams.re_ip"
          placeholder="请输入登录地址"
          clearable
          style="width: 240px;"
          size="small"
...
<script>
import { list, delLogininfor, exportLogininfor } from "@/api/monitor/logininfor"
import { requestParam } from '../../../utils'
import { initLoginLogQuery } from '../../../operation/loginLog'
...
export default {
  ...
  created() {
    ...
    this.$graphql(initLoginLogQuery,{request:req}).then(response => {
